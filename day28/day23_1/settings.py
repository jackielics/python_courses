"""
Django settings for day23_1 project.
...
SECRET_KEY = 'django-insecure-xg=f0e^lx$4fk21o+mrqi*h@f)n#nv-mx83js4x$26!-m#0x6b'
...
WSGI_APPLICATION = 'day23_1.wsgi.application'
